    ...
    <Container as='footer' role='contentinfo' maxW='7xl'>
      ...
      >
        <Stack spacing={{ base: '6', md: '8' }} align='start'>
          <Flex alignItems='center'>
            <Icon as={FaHelicopter} h={10} w={10} color={useColorModeValue('orange.500', 'orange.600')} />
            <Text fontSize='2xl' fontWeight='extrabold'>Gear Up</Text>
          </Flex>
          <Text color='muted'>We love fitness.</Text>
        </Stack>
      ...
      <Stack pt='8' pb='12' justify='space-between' direction={{ base: 'column-reverse', md: 'row' }} align='center'>
        <Text fontSize='sm' color='subtle'>
          &copy; {new Date().getFullYear()} Gear Up, Inc. All rights reserved.
        </Text>
